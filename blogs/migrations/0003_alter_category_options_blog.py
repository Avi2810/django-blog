...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blogs', '0002_alter_category_category_name'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.ImageField(upload_to='uploads/%Y-%m-%d', verbose_name='Featured Image')),
                ('short_description', models.TextField(max_length=500, verbose_name='Short Description')),
                ('blog_body', models.TextField(max_length=2000, verbose_name='Blog Body')),
